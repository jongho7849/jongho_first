...
SCHOOL_PROFILES = {
    ...
    "창원남고": [
        "성산구 대표 남자 상위권 일반고로, 학업·학생회 활동이 모두 활발한 편입니다.",
        "상남·사파·용호권 학생들에게 통학이 유리한 편입니다.",
        "수능 대비 집중 관리와 자율학습 문화가 형성되어 있습니다.",
    ],
    "마산고": [
        "마산권 전통 있는 남자 일반고로, 지역 상위권 학생이 많이 진학합니다.",
        "양덕·합성·회원·내서 등 마산 핵심권 중학교에서 진학 비율이 높습니다.",
        "수능 중심 진학을 준비하는 학생 비중이 높은 편입니다.",
    ],
    "명지여고": [
        "성산·의창권 여학생들이 많이 지원하는 상위권 여고입니다.",
        "내신·비교과를 균형 있게 관리하며 학생부종합 대비에 유리한 편입니다.",
        "상남·사파·용호·용지 일대에서 통학 접근성이 좋습니다.",
    ],
    "창원여고": [
        "창원 전역에서 여학생이 지원하는 일반 여고입니다.",
        "내신 부담을 과도하게 높이지 않으면서도 상위권 진학을 노려볼 수 있는 편입니다.",
        "중위권~상위권 여학생이 안정적으로 진학 전략을 세우기에 적합합니다.",
    ],
    "마산여고": [
        "마산권 대표 여고로, 마산·진해권 여학생들에게 선택 폭을 넓혀주는 학교입니다.",
        "내신 관리와 학교생활의 균형을 원하는 학생에게 적합합니다.",
        "마산고·문성고 등과 함께 마산권 지망 조합에 자주 포함되는 학교입니다.",
    ],
    "진해고": [
        "진해권 대표 남자 일반고로, 지역 거주 학생에게 통학이 가장 유리합니다.",
        "지역 밀착형 학교로, 통학 피로도를 줄이고 학업에 집중하기 좋은 편입니다.",
        "진해·경계 지역 중학교 학생들의 1·2지망에 자주 포함됩니다.",
    ],
    "진해여고": [
        "진해권 여학생의 주요 선택지로, 진해권 내신 관리에 유리한 학교입니다.",
        "통학 거리·생활 패턴을 안정적으로 가져가고 싶은 학생에게 적합합니다.",
        "진해고와 함께 진해권 조합(남·여)을 구성할 때 자주 활용됩니다.",
    ],
    "사파고": [
        "의창·성산 경계에서 통학성이 좋고, 내신 관리에 유리한 편인 일반고입니다.",
        "상위권 도전보다는 안정적인 내신과 학교생활을 우선하는 학생에게 적합합니다.",
        "창원중앙고·창원남고와 함께 조합할 때 안전 지망 역할을 합니다.",
    ],
    "문성고": [
        "마산권·의창권 학생 모두에게 선택 가능한 일반고입니다.",
        "내신 난도가 상대적으로 과도하지 않아 중상위권 학생에게 안정 지망이 됩니다.",
        "사파고와 함께 ‘안정 조합’으로 배치하는 경우가 많습니다.",
    ],
    "신월고": [
        "통학과 학업 부담을 종합적으로 고려한 안전 지망 역할을 하는 일반고입니다.",
...
def recommend_schools(
    ...
    cluster_desc = cluster_map.get(cluster, "일반권")
